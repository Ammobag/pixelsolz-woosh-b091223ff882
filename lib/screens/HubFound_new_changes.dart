...
class _HubFoundState extends BaseDeviceSetupState<HubFound> with MainPage {
  ...
  refreshUntillData() async {
    ...
    widget.showPageLoaderWithLogo(context,true,text: "Searching for hubs");
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Please active your bluetooth", textAlign: TextAlign.center,)
            ],
          ),
        ),
        actions: [
          ...
          Center(
            child: SizedBox(
              ...
              child: OutlinedButton(
                  ...
                  child: const Text('Exit App', style: TextStyle(fontSize: 17),)
              ),
            ),
          ),
          SizedBox(height: 20,)]
          else const Text('Exit App', textAlign: TextAlign.center, style: TextStyle(fontSize: 17),)
        ],
      );
      showDialog(
        context: context,
...
/*   setupSocket(){
              ...
              child: GestureDetector(
                  onTap: () async{
                    try {
                        ...
                        widget.setLoader(true);
                        widget.showPageLoaderWithLogo(context, true,text: "Connecting to hub");
                        /* widget.showPageLoader(context, true,
                            text:
  ...
  @override
  Widget body() {
    return devicesList.length == 0 ? HubWifi((){
      // widget.showPageLoader(context, true);
          // widget.setLoader(false);
      refreshDevice(is_manual_refresh: true);
    }, "No hub found") :  Padding(
